...
def usb(hold): # def for usb 
    ...
    ser.write(b"q")    # lets me know its a start of a new line
    for i in hold:     # set i equal to to everything in hold 1 by 1
        ...
        ser.write(str1encoded)  # sends the bytes
    ser.write(b"w")    # lets me know its the end of a line
...
ser = serial.Serial('/dev/ttyAMA1',9600) # sets serial port for usb
